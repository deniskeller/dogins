...
const HongKong: React.FC = () => {
	...
	return (
		<>
			<HeaderCountry
				image='hong-kong-bg.jpeg'
				title='Hong Kong'
				background_position='100% 80%'
			/>
								...
								<div className={s.StepByStepGuide}>
									...
									<ol className={s.StepByStepGuide_List}>
										...
										<li>
											...
											Answers to the official enquiries of the HKMA and
											provision of revised documents, if needed.
										</li>
										<li>
											The decision of the HKMA: <br />
											The decision of the HKMA regarding the issuance of payment
											institution licence.
										</li>
									</ol>
									...
									<div className={s.StepByStepGuide_Aside}>
										<p>
											...
											internal processes of the HKMA and the workload of
