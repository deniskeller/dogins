...
const Singapore: React.FC = () => {
	...
	return (
		<>
			<HeaderCountry
				image='singapore-bg.jpeg'
				title='Singapore'
				background_position='100% 78%'
			/>
								...
								<div className={s.StepByStepGuide}>
									...
									<ol className={s.StepByStepGuide_List}>
										...
										<li>
											...
											Answers to the official enquiries of the MAS and provision
											of revised documents, if needed.
										</li>
										<li>
											The decision of the MAS: <br />
											The decision of the MAS regarding the issuance of payment
											institution licence.
										</li>
									</ol>
									...
									<div className={s.StepByStepGuide_Aside}>
										<p>
											...
											internal processes of the MAS and the workload of
