...
const Ireland: React.FC = () => {
	...
	return (
		<>
			<HeaderCountry
				image='ireland-bg.jpeg'
				title='Ireland'
				background_position='100% 35%'
			/>
								...
								<div className={s.StepByStepGuide}>
									...
									<ol className={s.StepByStepGuide_List}>
										...
										<li>
											...
											Answers to the official enquiries of the Central Bank of
											Ireland and provision of revised documents, if needed.
										</li>
										<li>
											The decision of the Central Bank of Ireland: <br /> The
											decision of the Central Bank of Ireland regarding the
