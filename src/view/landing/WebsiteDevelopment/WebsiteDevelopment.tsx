	...
	return (
		<>
			...
			<div className={s.WebsiteDevelopment}>
						...
						<div className={s.WebsiteDevelopment_Item}>
							...
							<div className={s.WebsiteDevelopment_Item_ListComponents}>
								<div className={s.Component}>
									...
									<div className={s.Component_Value}>from £ 25,000</div>
								</div>
								...
								<div className={s.Component}>
									...
									<div className={s.Component_Value}>from £ 35,000</div>
								</div>
								...
								<div className={s.Component}>
									<div className={s.Component_Label}>
										...
										/>
										<div className={s.Component_Label_Name}>
											<p>Corporate Brand Identity & Style Guidelines</p>
										</div>
									</div>
								...
								<div className={s.Component}>
									<div className={s.Component_Label}>
										...
										/>
										<div className={s.Component_Label_Name}>
											<p>Brand Strategy & Copywriting (English)</p>
										</div>
									</div>
								...
								<div className={s.Component}>
									...
									<div className={s.Component_Value}>£ 2,500 / monthly</div>
								</div>
							</div>
						</div>
						{/* 2 */}
							...
							<div className={s.WebsiteDevelopment_Item_ListComponents}>
								...
								<div className={s.Component}>
									<div className={s.Component_Label}>
										...
										/>
										<div className={s.Component_Label_Name}>
											<p>Third-party Platform Integration</p>
										</div>
									</div>

									<div className={s.Component_Value}>from £ 5,000</div>
								</div>
								...
								<div className={s.Component}>
									<div className={s.Component_Label}>
										...
										/>
										<div className={s.Component_Label_Name}>
											<p>Corporate Brand Identity</p>
										</div>
									</div>

									<div className={s.Component_Value}>£ 5,000</div>
								</div>
				...
				<BaseContainer className={s.BaseContainer2}>
					<PricingInsideNavbar
